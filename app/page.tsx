    ...
    <main className="mainContent">
      ...
      <section id="secondHome" className="bg-light py-5">
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <h2 className="mb-3">Streamline Your Links with Our Free URL Shortener</h2>
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-9 text-center">
              <small>Great Connections Start with a click OR SCAN</small>
              <h2 className="text-center mb-3">The Connections Platform</h2>
              ...
              <div className="startedToday">
                ...
                <div className="startedTodayContent px-4">
                  <div className="d-flex gap-3 flex-auto justify-content-center">
                    <h4 className="w-75">URL Shortener</h4>
                  ...
                  <p className="cardDescription">A comprehensive solution to help make every point of connection between your content and your audience more powerful.</p>
                  <div className="startedTodayContentMore">
                    <h5>Popular URL Shortening Features</h5>
                    <ul>
            ...
            <div className="col-lg-4">
              <div className="startedToday">
                ...
                <div className="startedTodayContent px-4">
                  ...
                  <p className="cardDescription">QR Code solutions for every customer, business and brand experience.</p>
                  <div className="startedTodayContentMore">
                    <h5>Popular QR Code Features</h5>
                    <ul>
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-12">
              <h2 className="text-center mb-5 mt-3">Why Choose OPN.MY?</h2>
            </div>
            <div className="col-4">
      ...
      <section id="sevenHome" className="py-5">
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-12">
              <h2 className="text-center mb-4">Why Security Matters to Us</h2>
          ...
          <div className="row">
            ...
            <div className="col-lg-3">
              <div className="homeStat">
                ...
                <h4>2M+</h4>
                <h5>Links & QR Codes created monthly</h5>
              </div>
            </div>
            <div className="col-lg-3">
              <div className="homeStat">
            ...
            <div className="col-lg-3">
              <div className="homeStat">
                ...
                <h4>1M+</h4>
                <h5>Reached (Clicks & Scans monthly)</h5>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="secondHome" className="bg-light py-5">
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <h2 className="mb-3">Simplify Your Links with Our Free URL Shortener</h2>
